...
他の方とハンズオン環境を共有している場合、せっかくですので、みなさんで質問を見たり回答したりできるように、共通のインデックスを使いましょう。どなたかが代表してインデックスを作成してください。

今回は以下のようにマッピングを定義しました。次のコマンドで QA アプリで利用する Elasticsearch のインデックスを作成しましょう:
