...
アクセスしたユーザ名、日時、 URL、結果コードやユーザエージェントなど、 Web トラフィックの分析に役立つ情報があります。しかしこれを問題なく取り込むには Nginx のログ仕様をチェックしなければなりません。そして、今見ているパターンが全てかも分かりません。

幸いなことに Filebeat にはポピュラーなソフトウェア向けに各種[モジュール](https://www.elastic.co/guide/en/beats/filebeat/current/filebeat-modules.html)が提供されています。モジュールは:
